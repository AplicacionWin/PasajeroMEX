...
//    public static final String GOOGLE_API_KEY = " AIzaSyAh9OgcosLuybd7aEn9B4-huX-RLsxP4ok";
    ...
    public static final String CODE = "66bthd624sRWvV#TaCznr8gBVGbrCk1hxx"; //prod
    ...
    public static final String CHECK_PHONENUMBER = "check-mobile";
    public static final String CHECK_SPONSOR = "check-username";
    ...
    public class ServiceType {
        ...
        //**public static final String HOST_URL = "http://167.172.108.140/";// dev server
        //**public static final String HOST_URL = "http://167.172.97.206/";// prod server
        public static final String HOST_URL = "http://colombia.aplicacionwin.com/";// pruebas
        ...
        //**public static final String WEBVIEW = "http://167.172.108.140/";// live server
        //**public static final String SOCKET_URL = "http://167.172.108.140:3000?type=user&id=";
        public static final String WEBVIEW = "http://colombia.aplicacionwin.com/";// live server
        public static final String SOCKET_URL = "http://colombia.aplicacionwin.com:3000?type=user&id=";
        ...
        public static final String VERIFICAR_BACKEND = BASE_URL + "verificar-email";
        public static final String VERIFICAR_CORREO = BASE_URL + "check-username";
        public static final String VERIFICAR_USUARIO = BASE_URL + "check-username";
        public static final String VERIFICAR_REFERIDO = BASE_URL + "check-username";
