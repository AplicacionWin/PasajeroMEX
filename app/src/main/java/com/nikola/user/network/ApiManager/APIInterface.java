...
import static com.nikola.user.Utils.Const.ServiceType.VERIFICAR_BACKEND;
import static com.nikola.user.Utils.Const.ServiceType.VERIFICAR_CORREO;
import static com.nikola.user.Utils.Const.ServiceType.VERIFICAR_REFERIDO;
import static com.nikola.user.Utils.Const.ServiceType.VERIFICAR_USUARIO;
...
public interface APIInterface {
    ...
    @FormUrlEncoded
    @POST(VERIFICAR_REFERIDO)
    Call<String> verificarReferido(
            @Field(APIConsts.Params.USERNAME) String username
    );
    @FormUrlEncoded
    @POST(VERIFICAR_BACKEND)
    Call<String> validar(
            @Field(APIConsts.Params.EMAIL) String email
    );
    @FormUrlEncoded
    @POST(VERIFICAR_CORREO)
    Call<String> verificarCorreo(
            @Field(APIConsts.Params.EMAIL) String email
    );
    @FormUrlEncoded
