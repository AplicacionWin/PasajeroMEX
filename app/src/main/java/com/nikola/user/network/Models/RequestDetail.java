...
public class RequestDetail implements Serializable {
    ...
    private String provider_arrival_time ,request_unique_id, driver_name, driver_picture,driver_car_picture,driver_car_number,driver_car_model,driver_car_color, driver_mobile, driver_rating,driver_id,vehical_img;
    private String s_lat, s_lon, d_lat, d_lon, s_address, d_address;
    private double driver_latitude,driver_longitude;
    private String request_type,no_tolls,distance_unit,cancellationFee,start_time;
    ...
    private boolean favoriteProvider;
    ...
    public boolean isFavoriteProvider() {
        return favoriteProvider;
    }

    public void setFavoriteProvider(boolean favoriteProvider) {
    ...
    public void setProvider_arrival_time(String provider_arrival_time) {
        this.provider_arrival_time = provider_arrival_time;
    }
    ...
    public String getProvider_arrival_time() {
        return provider_arrival_time;
    }
